...
<p>We're not going to directly access ApiHandler from our controller class, it's going to be set up as a <a href="http://docs.ppi.io/latest/book/services.html" title="" target="_blank">service</a>. In your <b>./modules/FourSquareModule/Module.php</b> file's <b>getServiceConfig()</b> method add the following code:</p>
