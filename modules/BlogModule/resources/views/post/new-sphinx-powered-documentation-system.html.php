...
<p>
    ...
    Each documentation version is on its own unique branch, so now we are actively using the <a href="http://github.com/ppi/docs/tree/2.0" title="2.0">2.0</a> and <a href="http://github.com/ppi/docs/tree/2.1" title="2.1">2.1</a> branches on that repo. 
