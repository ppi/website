...
<!--                    <a href="--><?//=$view['router']->generate('BlogGetRSS');?><!--"><img src="--><?//= $view['assets']->getUrl('images/rss.png');?><!--" width="38" /></a>-->
    ...
    <div class="whos-using-ppi">
        ...
        <ul class="clearfix">
            ...
            <li class="twland"><a href="http://store.tomorrowland.com" title="Tomorrowland" target="_blank"><img src="<?=$view['assets']->getUrl('images/who/tomorrowland.png');?>" alt=""></a></li>
            <li><a href="#" onclick="javascript: void(0);" title="NHS Local" target="_blank"><img src="<?=$view['assets']->getUrl('images/who/nhs.jpg');?>" alt=""></a></li>
            <li><a href="http://www.talentize.com" title="Talentize" target="_blank"><img src="<?=$view['assets']->getUrl('images/who/talentize.png');?>" alt=""></a></li>
