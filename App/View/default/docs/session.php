<article class="content-box docs-page">
	...
	<h5 id="anchor-accessing-the-session">Accessing The Session</h5>
...
$this->getSession()->set('foo', $bar);</code></pre>
	...
	<h5 id="anchor-setting-session-data">Setting session data</h5>
	<pre><code class="php">$this->getSession()->set('projectData', array('foo' => 'bar'));</code></pre>

	<h5 id="anchor-getting-session-data">Getting session data</h5>
	...
	<h5 id="anchor-removing-all-data">Removing all data</h5>
	<pre><code class="php">$bar = $this->getSession()->removeAll();</code></pre>

	<h5 id="anchor-setting-the-logged-in-users-data">Setting the logged in users data</h5>
	<pre><code class="php">$this->getSession()->setAuthData($userInfoFromDatabase);</code></pre>

	<h5 id="anchor-getting-the-logged-in-users-data">Getting the logged in users data</h5>
