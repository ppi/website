<article class="content-box docs-page">
	...
	<pre><code class="php">$this->render('template_name');</code></pre>
...
?&gt;</code></pre>
	...
	<pre><code class="php">// This example loads the profile template and passes it the current logged in users data
...
&lt;h1>Welcome to the &lt;?php echo $projectInfo['title']; ?&gt; project&lt;/h1>
	...
	<pre><code class="php">if($request['controller'] == 'profile') {
	...
	<pre><code class="php">if($request['controller'] == 'profile' && $request['method']) {
	// do something here
}</code></pre>
