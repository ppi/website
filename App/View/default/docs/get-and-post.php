<article class="content-box docs-page">
	...
	<aside class="toc">
		...
		<ul class="items">
			...
			<li><a href="#" title="">Getting params from the URL</a></li>
			<li><a href="#" title="">Detecting form submits</a></li>
			<li><a href="#" title="">Getting params from POST</a></li>
			<li><a href="#" title="">Checking if a POST field exists</a></li>
			<li><a href="#" title="">Getting prefixed POST fields</a></li>
			<li><a href="#" title="">Adding POST fields</a></li>
			<li><a href="#" title="">Removing POST fields</a></li>
			<li><a href="#" title="">Emptying POST data</a></li>
		</ul>
	</aside>
	...
	<pre><code class="php">// url: www.site.com/user/profile/userid/4
...
var_dump($userID); // null
	...
	<pre><code class="php">if($this->hasPost('username')) {</code></pre>
	...
	<pre><code class="php">/* Fields: user_id
user_email
user_password
profile_image
profile_status
...
*/
	...
	<pre><code class="php">if($this->hasPost('username')) {
...
$postValues = $this->post();
	...
	<pre><code class="php">if($this->hasPost('hidden_userid')) {
...
$formValues = $this->post();
	...
	<pre><code class="php">$formValues = $this->post();
