<article class="content-box docs-page">
	...
	<pre class="php"><code class="php">$connections['my_connection_key'] = array(
    'type'   => 'pdo_mysql',
    'host'   => 'localhost',
    'dbname' => 'my_db_name',
    'user'   => 'my_db_user',
...
$ds = \PPI\DataSource::create($connections);</code></pre>
	...
	<pre class="php"><code class="php">$connection = $ds->getConnection('my_connection_key');</code></pre>
...
$app->boot();</code></pre>
	...
	<pre class="php"><code class="php">use PPI\Core;
