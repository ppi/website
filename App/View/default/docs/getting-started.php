		...
		<section class='content'>
			...
			<article id='overview'>
				...
				<p>PPI is an open source framework for developing web applications and services with PHP 5.3. PPI is
					...
					re-use existing technologies instead of making its own. Therefore if you know Symfony2 you now know
					70% of PPI. If you know ZendFramework2 you're in good hands too. If you have used Doctrine2 before,
					you know how to talk to databases.</p>

				<p>You'll not only be able to quickly pick up PPI but it's teaching you Symfony2, ZendFramework2 and
					Doctrine2 at the same time. Their features have been introduced to you in a very simple and friendly
					environment. Knowledge you gain from using PPI will be invaluable to you out there in the
					wild-wild-web.</p>

				<p>On the flip-side if you have used Symfony2 or ZendFramework2 then the learning curve for using PPI is
					dramatically reduced. There is no custom magic being used here. All the time you've invested
