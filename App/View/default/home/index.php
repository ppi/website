...
<!--							<p>The PPI Framework is a lightweight and simple web app framework for PHP5.2 and above. PPI introduces simplicity balanced with maintainability, scalability and extensibility. With a small learning curve and a rich set of learning material available PPI is a great way to sit back and make web dev fun and easy.</p> -->
					...
					<div class="download item">
						...
						<div class="item-content">
							<h3><a href="<?= $baseUrl; ?>downloads">downloads</a></h3>
				...
				<div class="item-container">
					<div class="development item">
						...
						<div class="item-content">
							<h3><a href="<?= $baseUrl; ?>community" title="Development">development</a></h3>
							<p>Want to get involved in the project? We're looking for designers, front-end developers and back-end developers. We will always have something to suit your mood. You can pick up a ticket on our <a href="http://tracker.ppi.io" title="Issue Tracker">Issue Tracker</a> and get stuck in.</p>
						</div>
					</div>
					<div class="github item">
						<a href="http://github.com/ppi"><img src="<?= $baseUrl; ?>images/icons-github.png" alt="github"></a>
						<div class="item-content">
